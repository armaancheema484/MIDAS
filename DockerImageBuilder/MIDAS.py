...
parser.add_argument("-t", "--tag", type=str, nargs='?', const=True, default=False, help="Name of the image if built, by default, no image will be built")
...
docker_image_name_pattern = re.compile(r"^[\w][\w.-]{0,127}$")
